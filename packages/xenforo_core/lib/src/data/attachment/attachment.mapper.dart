...
class XenForoAttachmentMapper extends ClassMapperBase<XenForoAttachment> {
  ...
  static const Field<XenForoAttachment, int> _f$attachmentId = Field(
    'attachmentId',
    _$attachmentId,
  );
  static String _$filename(XenForoAttachment v) => v.filename;
  static const Field<XenForoAttachment, String> _f$filename = Field(
    'filename',
    _$filename,
  );
  static int _$fileSize(XenForoAttachment v) => v.fileSize;
  static const Field<XenForoAttachment, int> _f$fileSize = Field(
    'fileSize',
    _$fileSize,
  );
  static int? _$height(XenForoAttachment v) => v.height;
  static const Field<XenForoAttachment, int> _f$height = Field(
    'height',
    _$height,
    opt: true,
  );
  static int? _$width(XenForoAttachment v) => v.width;
  static const Field<XenForoAttachment, int> _f$width = Field(
    'width',
    _$width,
    opt: true,
  );
  static String? _$thumbnailUrl(XenForoAttachment v) => v.thumbnailUrl;
  static const Field<XenForoAttachment, String> _f$thumbnailUrl = Field(
    'thumbnailUrl',
    _$thumbnailUrl,
    opt: true,
  );
  static String? _$directUrl(XenForoAttachment v) => v.directUrl;
  static const Field<XenForoAttachment, String> _f$directUrl = Field(
    'directUrl',
    _$directUrl,
    opt: true,
  );
  static bool? _$isVideo(XenForoAttachment v) => v.isVideo;
  static const Field<XenForoAttachment, bool> _f$isVideo = Field(
    'isVideo',
    _$isVideo,
    opt: true,
  );
  static bool? _$isAudio(XenForoAttachment v) => v.isAudio;
  static const Field<XenForoAttachment, bool> _f$isAudio = Field(
    'isAudio',
    _$isAudio,
    opt: true,
  );
  static String? _$contentType(XenForoAttachment v) => v.contentType;
  static const Field<XenForoAttachment, String> _f$contentType = Field(
    'contentType',
    _$contentType,
    opt: true,
  );
  static int? _$contentId(XenForoAttachment v) => v.contentId;
  static const Field<XenForoAttachment, int> _f$contentId = Field(
    'contentId',
    _$contentId,
    opt: true,
  );
  static int? _$attachDate(XenForoAttachment v) => v.attachDate;
  static const Field<XenForoAttachment, int> _f$attachDate = Field(
    'attachDate',
    _$attachDate,
    opt: true,
  );
  static int? _$viewCount(XenForoAttachment v) => v.viewCount;
  static const Field<XenForoAttachment, int> _f$viewCount = Field(
    'viewCount',
    _$viewCount,
    opt: true,
  );
...
mixin XenForoAttachmentMappable {
  ...
  get copyWith =>
      _XenForoAttachmentCopyWithImpl<XenForoAttachment, XenForoAttachment>(
        this as XenForoAttachment,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return XenForoAttachmentMapper.ensureInitialized().stringifyValue(
      this as XenForoAttachment,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoAttachmentMapper.ensureInitialized().equalsValue(
      this as XenForoAttachment,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoAttachmentMapper.ensureInitialized().hashValue(
      this as XenForoAttachment,
    );
  }
}
...
extension XenForoAttachmentValueCopy<$R, $Out>
  ...
  get $asXenForoAttachment => $base.as(
    (v, t, t2) => _XenForoAttachmentCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class XenForoAttachmentCopyWith<
  $R,
  $In extends XenForoAttachment,
  $Out
>
