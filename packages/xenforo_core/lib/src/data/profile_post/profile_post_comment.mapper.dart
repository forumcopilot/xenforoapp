...
class XenForoProfilePostCommentMapper
  ...
  static XenForoProfilePostCommentMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = XenForoProfilePostCommentMapper._());
  ...
  static const Field<XenForoProfilePostComment, String> _f$username =
  ...
  static const Field<XenForoProfilePostComment, int> _f$reactionScore =
      Field('reactionScore', _$reactionScore, opt: true);
  static XenForoUser? _$user(XenForoProfilePostComment v) => v.user;
  static const Field<XenForoProfilePostComment, XenForoUser> _f$user =
...
mixin XenForoProfilePostCommentMappable {
  ...
  XenForoProfilePostCommentCopyWith<XenForoProfilePostComment,
          XenForoProfilePostComment, XenForoProfilePostComment>
      get copyWith => _XenForoProfilePostCommentCopyWithImpl<
              XenForoProfilePostComment, XenForoProfilePostComment>(
          this as XenForoProfilePostComment, $identity, $identity);
  @override
  String toString() {
    return XenForoProfilePostCommentMapper.ensureInitialized()
        .stringifyValue(this as XenForoProfilePostComment);
  }

  @override
  bool operator ==(Object other) {
    return XenForoProfilePostCommentMapper.ensureInitialized()
        .equalsValue(this as XenForoProfilePostComment, other);
  }

  @override
  int get hashCode {
    return XenForoProfilePostCommentMapper.ensureInitialized()
        .hashValue(this as XenForoProfilePostComment);
  }
}
...
extension XenForoProfilePostCommentValueCopy<$R, $Out>
  ...
  XenForoProfilePostCommentCopyWith<$R, XenForoProfilePostComment, $Out>
      get $asXenForoProfilePostComment => $base.as((v, t, t2) =>
          _XenForoProfilePostCommentCopyWithImpl<$R, $Out>(v, t, t2));
}
