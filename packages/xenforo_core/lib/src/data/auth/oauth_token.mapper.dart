...
class OAuthTokenMapper extends ClassMapperBase<OAuthToken> {
  ...
  static const Field<OAuthToken, String> _f$accessToken = Field(
    'accessToken',
    _$accessToken,
  );
  static String? _$refreshToken(OAuthToken v) => v.refreshToken;
  static const Field<OAuthToken, String> _f$refreshToken = Field(
    'refreshToken',
    _$refreshToken,
    opt: true,
  );
  static String _$tokenType(OAuthToken v) => v.tokenType;
  static const Field<OAuthToken, String> _f$tokenType = Field(
    'tokenType',
    _$tokenType,
    opt: true,
    def: 'Bearer',
  ...
  static const Field<OAuthToken, int> _f$expiresIn = Field(
    'expiresIn',
    _$expiresIn,
    opt: true,
  );
  static int? _$expiresAt(OAuthToken v) => v.expiresAt;
  static const Field<OAuthToken, int> _f$expiresAt = Field(
    'expiresAt',
    _$expiresAt,
    opt: true,
  );
  static List<String>? _$scopes(OAuthToken v) => v.scopes;
  static const Field<OAuthToken, List<String>> _f$scopes = Field(
    'scopes',
    _$scopes,
    opt: true,
  );
...
mixin OAuthTokenMappable {
  String toJson() {
    return OAuthTokenMapper.ensureInitialized().encodeJson<OAuthToken>(
      this as OAuthToken,
    );
  }

  Map<String, dynamic> toMap() {
    return OAuthTokenMapper.ensureInitialized().encodeMap<OAuthToken>(
      this as OAuthToken,
    );
  }
  ...
  @override
  String toString() {
    return OAuthTokenMapper.ensureInitialized().stringifyValue(
      this as OAuthToken,
    );
  }
  ...
  bool operator ==(Object other) {
    return OAuthTokenMapper.ensureInitialized().equalsValue(
      this as OAuthToken,
      other,
    );
  }
