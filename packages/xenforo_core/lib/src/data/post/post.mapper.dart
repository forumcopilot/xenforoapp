...
mixin XenForoPostMappable {
  String toJson() {
    return XenForoPostMapper.ensureInitialized()
        .encodeJson<XenForoPost>(this as XenForoPost);
  }

  Map<String, dynamic> toMap() {
    return XenForoPostMapper.ensureInitialized()
        .encodeMap<XenForoPost>(this as XenForoPost);
  }

  XenForoPostCopyWith<XenForoPost, XenForoPost, XenForoPost> get copyWith =>
      _XenForoPostCopyWithImpl<XenForoPost, XenForoPost>(
          this as XenForoPost, $identity, $identity);
  @override
  String toString() {
    return XenForoPostMapper.ensureInitialized()
        .stringifyValue(this as XenForoPost);
  }

  @override
  bool operator ==(Object other) {
    return XenForoPostMapper.ensureInitialized()
        .equalsValue(this as XenForoPost, other);
  }
