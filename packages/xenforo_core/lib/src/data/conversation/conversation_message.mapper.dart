...
class XenForoConversationMessageMapper
  ...
  static XenForoConversationMessageMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = XenForoConversationMessageMapper._(),
      );
  ...
  static const Field<XenForoConversationMessage, String> _f$username = Field(
    'username',
    _$username,
    opt: true,
  );
  static bool? _$isUnread(XenForoConversationMessage v) => v.isUnread;
  static const Field<XenForoConversationMessage, bool> _f$isUnread = Field(
    'isUnread',
    _$isUnread,
    opt: true,
  );
  ...
  static const Field<XenForoConversationMessage, bool> _f$canEdit = Field(
    'canEdit',
    _$canEdit,
    opt: true,
  );
  static bool? _$canReact(XenForoConversationMessage v) => v.canReact;
  static const Field<XenForoConversationMessage, bool> _f$canReact = Field(
    'canReact',
    _$canReact,
    opt: true,
  );
  static String? _$viewUrl(XenForoConversationMessage v) => v.viewUrl;
  static const Field<XenForoConversationMessage, String> _f$viewUrl = Field(
    'viewUrl',
    _$viewUrl,
    opt: true,
  );
  ...
  static const Field<XenForoConversationMessage, bool> _f$isReactedTo = Field(
    'isReactedTo',
    _$isReactedTo,
    opt: true,
  );
  ...
  static const Field<XenForoConversationMessage, int> _f$messageId = Field(
    'messageId',
    _$messageId,
  );
  static int? _$conversationId(XenForoConversationMessage v) =>
      v.conversationId;
  static const Field<XenForoConversationMessage, int> _f$conversationId = Field(
    'conversationId',
    _$conversationId,
    opt: true,
  );
  static int? _$messageDate(XenForoConversationMessage v) => v.messageDate;
  static const Field<XenForoConversationMessage, int> _f$messageDate = Field(
    'messageDate',
    _$messageDate,
    opt: true,
  );
  static int? _$userId(XenForoConversationMessage v) => v.userId;
  static const Field<XenForoConversationMessage, int> _f$userId = Field(
    'userId',
    _$userId,
    opt: true,
  );
  static String? _$message(XenForoConversationMessage v) => v.message;
  static const Field<XenForoConversationMessage, String> _f$message = Field(
    'message',
    _$message,
    opt: true,
  );
  static int? _$attachCount(XenForoConversationMessage v) => v.attachCount;
  static const Field<XenForoConversationMessage, int> _f$attachCount = Field(
    'attachCount',
    _$attachCount,
    opt: true,
  );
  static int? _$reactionScore(XenForoConversationMessage v) => v.reactionScore;
  static const Field<XenForoConversationMessage, int> _f$reactionScore = Field(
    'reactionScore',
    _$reactionScore,
    opt: true,
  );
  static XenForoUser? _$user(XenForoConversationMessage v) => v.user;
  static const Field<XenForoConversationMessage, XenForoUser> _f$user = Field(
    'user',
    _$user,
    opt: true,
  );
...
mixin XenForoConversationMessageMappable {
  ...
  XenForoConversationMessageCopyWith<
    XenForoConversationMessage,
    XenForoConversationMessage,
    XenForoConversationMessage
  >
  get copyWith =>
      _XenForoConversationMessageCopyWithImpl<
        XenForoConversationMessage,
        XenForoConversationMessage
      >(this as XenForoConversationMessage, $identity, $identity);
  @override
  String toString() {
    return XenForoConversationMessageMapper.ensureInitialized().stringifyValue(
      this as XenForoConversationMessage,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoConversationMessageMapper.ensureInitialized().equalsValue(
      this as XenForoConversationMessage,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoConversationMessageMapper.ensureInitialized().hashValue(
      this as XenForoConversationMessage,
    );
  }
}
...
extension XenForoConversationMessageValueCopy<$R, $Out>
  ...
  get $asXenForoConversationMessage => $base.as(
    (v, t, t2) => _XenForoConversationMessageCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _XenForoConversationMessageCopyWithImpl<$R, $Out>
  ...
  @override
  XenForoConversationMessage $make(CopyWithData data) =>
      XenForoConversationMessage(
