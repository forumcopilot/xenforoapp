...
class XenForoConfigMapper extends ClassMapperBase<XenForoConfig> {
  ...
  static const Field<XenForoConfig, String> _f$versionId = Field(
    'versionId',
    _$versionId,
  );
  static String _$versionString(XenForoConfig v) => v.versionString;
  static const Field<XenForoConfig, String> _f$versionString = Field(
    'versionString',
    _$versionString,
  );
  static String _$apiVersion(XenForoConfig v) => v.apiVersion;
  static const Field<XenForoConfig, String> _f$apiVersion = Field(
    'apiVersion',
    _$apiVersion,
  );
  ...
  static const Field<XenForoConfig, String> _f$tagline = Field(
    'tagline',
    _$tagline,
  );
  ...
  static const Field<XenForoConfig, String> _f$baseUrl = Field(
    'baseUrl',
    _$baseUrl,
  );
  static String _$timezone(XenForoConfig v) => v.timezone;
  static const Field<XenForoConfig, String> _f$timezone = Field(
    'timezone',
    _$timezone,
  );
  static String _$language(XenForoConfig v) => v.language;
  static const Field<XenForoConfig, String> _f$language = Field(
    'language',
    _$language,
  );
  static String _$currency(XenForoConfig v) => v.currency;
  static const Field<XenForoConfig, String> _f$currency = Field(
    'currency',
    _$currency,
  );
  static String _$dateFormat(XenForoConfig v) => v.dateFormat;
  static const Field<XenForoConfig, String> _f$dateFormat = Field(
    'dateFormat',
    _$dateFormat,
  );
  static String _$timeFormat(XenForoConfig v) => v.timeFormat;
  static const Field<XenForoConfig, String> _f$timeFormat = Field(
    'timeFormat',
    _$timeFormat,
  );
  static bool _$debugMode(XenForoConfig v) => v.debugMode;
  static const Field<XenForoConfig, bool> _f$debugMode = Field(
    'debugMode',
    _$debugMode,
  );
  static bool _$developmentMode(XenForoConfig v) => v.developmentMode;
  static const Field<XenForoConfig, bool> _f$developmentMode = Field(
    'developmentMode',
    _$developmentMode,
  );
  static bool _$maintenanceMode(XenForoConfig v) => v.maintenanceMode;
  static const Field<XenForoConfig, bool> _f$maintenanceMode = Field(
    'maintenanceMode',
    _$maintenanceMode,
  );
  static String _$maintenanceMessage(XenForoConfig v) => v.maintenanceMessage;
  static const Field<XenForoConfig, String> _f$maintenanceMessage = Field(
    'maintenanceMessage',
    _$maintenanceMessage,
  );
  static Map<String, dynamic> _$options(XenForoConfig v) => v.options;
  static const Field<XenForoConfig, Map<String, dynamic>> _f$options = Field(
    'options',
    _$options,
  );
  ...
  static const Field<XenForoConfig, Map<String, dynamic>> _f$features = Field(
    'features',
    _$features,
  );
...
mixin XenForoConfigMappable {
  String toJson() {
    return XenForoConfigMapper.ensureInitialized().encodeJson<XenForoConfig>(
      this as XenForoConfig,
    );
  }

  Map<String, dynamic> toMap() {
    return XenForoConfigMapper.ensureInitialized().encodeMap<XenForoConfig>(
      this as XenForoConfig,
    );
  }
  ...
  @override
  String toString() {
    return XenForoConfigMapper.ensureInitialized().stringifyValue(
      this as XenForoConfig,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoConfigMapper.ensureInitialized().equalsValue(
      this as XenForoConfig,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoConfigMapper.ensureInitialized().hashValue(
      this as XenForoConfig,
    );
  }
}
