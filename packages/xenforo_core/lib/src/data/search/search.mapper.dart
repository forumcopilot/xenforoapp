...
mixin XenForoSearchMappable {
  String toJson() {
    return XenForoSearchMapper.ensureInitialized()
        .encodeJson<XenForoSearch>(this as XenForoSearch);
  }

  Map<String, dynamic> toMap() {
    return XenForoSearchMapper.ensureInitialized()
        .encodeMap<XenForoSearch>(this as XenForoSearch);
  }
  ...
  XenForoSearchCopyWith<XenForoSearch, XenForoSearch, XenForoSearch>
      get copyWith => _XenForoSearchCopyWithImpl<XenForoSearch, XenForoSearch>(
          this as XenForoSearch, $identity, $identity);
  @override
  String toString() {
    return XenForoSearchMapper.ensureInitialized()
        .stringifyValue(this as XenForoSearch);
  }

  @override
  bool operator ==(Object other) {
    return XenForoSearchMapper.ensureInitialized()
        .equalsValue(this as XenForoSearch, other);
  }

  @override
  int get hashCode {
    return XenForoSearchMapper.ensureInitialized()
        .hashValue(this as XenForoSearch);
  }
}
