...
class XenForoAlertMapper extends ClassMapperBase<XenForoAlert> {
  ...
  static const Field<XenForoAlert, bool> _f$isDismissed =
      Field('isDismissed', _$isDismissed);
  static Map<String, dynamic> _$extraData(XenForoAlert v) => v.extraData;
  static const Field<XenForoAlert, Map<String, dynamic>> _f$extraData =
...
mixin XenForoAlertMappable {
  String toJson() {
    return XenForoAlertMapper.ensureInitialized()
        .encodeJson<XenForoAlert>(this as XenForoAlert);
  }

  Map<String, dynamic> toMap() {
    return XenForoAlertMapper.ensureInitialized()
        .encodeMap<XenForoAlert>(this as XenForoAlert);
  }
  ...
  XenForoAlertCopyWith<XenForoAlert, XenForoAlert, XenForoAlert> get copyWith =>
      _XenForoAlertCopyWithImpl<XenForoAlert, XenForoAlert>(
          this as XenForoAlert, $identity, $identity);
  @override
  String toString() {
    return XenForoAlertMapper.ensureInitialized()
        .stringifyValue(this as XenForoAlert);
  }

  @override
  bool operator ==(Object other) {
    return XenForoAlertMapper.ensureInitialized()
        .equalsValue(this as XenForoAlert, other);
  }

  @override
  int get hashCode {
    return XenForoAlertMapper.ensureInitialized()
        .hashValue(this as XenForoAlert);
  }
}
