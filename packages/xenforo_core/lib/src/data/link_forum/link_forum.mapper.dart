...
class XenForoLinkForumMapper extends ClassMapperBase<XenForoLinkForum> {
  ...
  static const Field<XenForoLinkForum, String> _f$linkUrl = Field(
    'linkUrl',
    _$linkUrl,
    opt: true,
  );
  static int? _$redirectCount(XenForoLinkForum v) => v.redirectCount;
  static const Field<XenForoLinkForum, int> _f$redirectCount = Field(
    'redirectCount',
    _$redirectCount,
    opt: true,
  );
...
mixin XenForoLinkForumMappable {
  ...
  get copyWith =>
      _XenForoLinkForumCopyWithImpl<XenForoLinkForum, XenForoLinkForum>(
        this as XenForoLinkForum,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return XenForoLinkForumMapper.ensureInitialized().stringifyValue(
      this as XenForoLinkForum,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoLinkForumMapper.ensureInitialized().equalsValue(
      this as XenForoLinkForum,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoLinkForumMapper.ensureInitialized().hashValue(
      this as XenForoLinkForum,
    );
  }
}
...
extension XenForoLinkForumValueCopy<$R, $Out>
  ...
  get $asXenForoLinkForum =>
      $base.as((v, t, t2) => _XenForoLinkForumCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _XenForoLinkForumCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? linkUrl = $none, Object? redirectCount = $none}) => $apply(
    FieldCopyWithData({
