...
class AuthResponseMapper extends ClassMapperBase<AuthResponse> {
  ...
  static const Field<AuthResponse, bool> _f$success = Field(
    'success',
    _$success,
  );
  static String? _$error(AuthResponse v) => v.error;
  static const Field<AuthResponse, String> _f$error = Field(
    'error',
    _$error,
    opt: true,
  );
  static String? _$errorCode(AuthResponse v) => v.errorCode;
  static const Field<AuthResponse, String> _f$errorCode = Field(
    'errorCode',
    _$errorCode,
    opt: true,
  );
  static OAuthToken? _$token(AuthResponse v) => v.token;
  static const Field<AuthResponse, OAuthToken> _f$token = Field(
    'token',
    _$token,
    opt: true,
  );
  static XenForoUser? _$user(AuthResponse v) => v.user;
  static const Field<AuthResponse, XenForoUser> _f$user = Field(
    'user',
    _$user,
    opt: true,
  );
  static Map<String, dynamic>? _$data(AuthResponse v) => v.data;
  static const Field<AuthResponse, Map<String, dynamic>> _f$data = Field(
    'data',
    _$data,
    opt: true,
  );
...
class XenForoOAuthTokenRequestMapper
  ...
  static XenForoOAuthTokenRequestMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = XenForoOAuthTokenRequestMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<XenForoOAuthTokenRequest, String> _f$grantType = Field(
    'grantType',
    _$grantType,
  );
  static String _$clientId(XenForoOAuthTokenRequest v) => v.clientId;
  static const Field<XenForoOAuthTokenRequest, String> _f$clientId = Field(
    'clientId',
    _$clientId,
  );
  static String _$clientSecret(XenForoOAuthTokenRequest v) => v.clientSecret;
  static const Field<XenForoOAuthTokenRequest, String> _f$clientSecret = Field(
    'clientSecret',
    _$clientSecret,
  );
  static String? _$username(XenForoOAuthTokenRequest v) => v.username;
  static const Field<XenForoOAuthTokenRequest, String> _f$username = Field(
    'username',
    _$username,
    opt: true,
  );
  static String? _$password(XenForoOAuthTokenRequest v) => v.password;
  static const Field<XenForoOAuthTokenRequest, String> _f$password = Field(
    'password',
    _$password,
    opt: true,
  );
  static String? _$refreshToken(XenForoOAuthTokenRequest v) => v.refreshToken;
  static const Field<XenForoOAuthTokenRequest, String> _f$refreshToken = Field(
    'refreshToken',
    _$refreshToken,
    opt: true,
  );
  static String? _$scope(XenForoOAuthTokenRequest v) => v.scope;
  static const Field<XenForoOAuthTokenRequest, String> _f$scope = Field(
    'scope',
    _$scope,
    opt: true,
  );
...
mixin XenForoOAuthTokenRequestMappable {
  ...
  XenForoOAuthTokenRequestCopyWith<
    XenForoOAuthTokenRequest,
    XenForoOAuthTokenRequest,
    XenForoOAuthTokenRequest
  >
  get copyWith =>
      _XenForoOAuthTokenRequestCopyWithImpl<
        XenForoOAuthTokenRequest,
        XenForoOAuthTokenRequest
      >(this as XenForoOAuthTokenRequest, $identity, $identity);
  @override
  String toString() {
    return XenForoOAuthTokenRequestMapper.ensureInitialized().stringifyValue(
      this as XenForoOAuthTokenRequest,
    );
  }

  @override
  bool operator ==(Object other) {
    return XenForoOAuthTokenRequestMapper.ensureInitialized().equalsValue(
      this as XenForoOAuthTokenRequest,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoOAuthTokenRequestMapper.ensureInitialized().hashValue(
      this as XenForoOAuthTokenRequest,
    );
  }
}
...
extension XenForoOAuthTokenRequestValueCopy<$R, $Out>
  ...
  get $asXenForoOAuthTokenRequest => $base.as(
    (v, t, t2) => _XenForoOAuthTokenRequestCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class XenForoOAuthTokenResponseMapper
  ...
  static XenForoOAuthTokenResponseMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = XenForoOAuthTokenResponseMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<XenForoOAuthTokenResponse, String> _f$accessToken = Field(
    'accessToken',
    _$accessToken,
  );
  static String? _$refreshToken(XenForoOAuthTokenResponse v) => v.refreshToken;
  static const Field<XenForoOAuthTokenResponse, String> _f$refreshToken = Field(
    'refreshToken',
    _$refreshToken,
    opt: true,
  );
  static String _$tokenType(XenForoOAuthTokenResponse v) => v.tokenType;
  static const Field<XenForoOAuthTokenResponse, String> _f$tokenType = Field(
    'tokenType',
    _$tokenType,
  );
  static int _$expiresIn(XenForoOAuthTokenResponse v) => v.expiresIn;
  static const Field<XenForoOAuthTokenResponse, int> _f$expiresIn = Field(
    'expiresIn',
    _$expiresIn,
  );
  static String? _$scope(XenForoOAuthTokenResponse v) => v.scope;
  static const Field<XenForoOAuthTokenResponse, String> _f$scope = Field(
    'scope',
    _$scope,
    opt: true,
  );
  static DateTime? _$createdAt(XenForoOAuthTokenResponse v) => v.createdAt;
  static const Field<XenForoOAuthTokenResponse, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    opt: true,
  );
...
mixin XenForoOAuthTokenResponseMappable {
  ...
  XenForoOAuthTokenResponseCopyWith<
    XenForoOAuthTokenResponse,
    XenForoOAuthTokenResponse,
    XenForoOAuthTokenResponse
  >
  get copyWith =>
      _XenForoOAuthTokenResponseCopyWithImpl<
        XenForoOAuthTokenResponse,
        XenForoOAuthTokenResponse
      >(this as XenForoOAuthTokenResponse, $identity, $identity);
  @override
  String toString() {
    return XenForoOAuthTokenResponseMapper.ensureInitialized().stringifyValue(
      this as XenForoOAuthTokenResponse,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return XenForoOAuthTokenResponseMapper.ensureInitialized().equalsValue(
      this as XenForoOAuthTokenResponse,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoOAuthTokenResponseMapper.ensureInitialized().hashValue(
      this as XenForoOAuthTokenResponse,
    );
  }
}
...
extension XenForoOAuthTokenResponseValueCopy<$R, $Out>
  ...
  get $asXenForoOAuthTokenResponse => $base.as(
    (v, t, t2) => _XenForoOAuthTokenResponseCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
