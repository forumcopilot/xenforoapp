...
class XenForoThreadMapper extends ClassMapperBase<XenForoThread> {
  ...
  static const Field<XenForoThread, List<int>> _f$highlightedPostIds =
...
mixin XenForoThreadMappable {
  String toJson() {
    return XenForoThreadMapper.ensureInitialized()
        .encodeJson<XenForoThread>(this as XenForoThread);
  }

  Map<String, dynamic> toMap() {
    return XenForoThreadMapper.ensureInitialized()
        .encodeMap<XenForoThread>(this as XenForoThread);
  }
  ...
  XenForoThreadCopyWith<XenForoThread, XenForoThread, XenForoThread>
      get copyWith => _XenForoThreadCopyWithImpl<XenForoThread, XenForoThread>(
          this as XenForoThread, $identity, $identity);
  @override
  String toString() {
    return XenForoThreadMapper.ensureInitialized()
        .stringifyValue(this as XenForoThread);
  }

  @override
  bool operator ==(Object other) {
    return XenForoThreadMapper.ensureInitialized()
        .equalsValue(this as XenForoThread, other);
  }

  @override
  int get hashCode {
    return XenForoThreadMapper.ensureInitialized()
        .hashValue(this as XenForoThread);
  }
}
