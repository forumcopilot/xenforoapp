...
class XenForoNodeMapper extends ClassMapperBase<XenForoNode> {
  ...
  static const Field<XenForoNode, Map<String, dynamic>> _f$typeData = Field(
    'typeData',
    _$typeData,
    opt: true,
  );
  static String? _$viewUrl(XenForoNode v) => v.viewUrl;
  static const Field<XenForoNode, String> _f$viewUrl = Field(
    'viewUrl',
    _$viewUrl,
    opt: true,
  );
  ...
  static const Field<XenForoNode, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static String? _$nodeName(XenForoNode v) => v.nodeName;
  static const Field<XenForoNode, String> _f$nodeName = Field(
    'nodeName',
    _$nodeName,
    opt: true,
  );
  static String? _$description(XenForoNode v) => v.description;
  static const Field<XenForoNode, String> _f$description = Field(
    'description',
    _$description,
    opt: true,
  );
  static String? _$nodeTypeId(XenForoNode v) => v.nodeTypeId;
  static const Field<XenForoNode, String> _f$nodeTypeId = Field(
    'nodeTypeId',
    _$nodeTypeId,
    opt: true,
  );
  static int? _$parentNodeId(XenForoNode v) => v.parentNodeId;
  static const Field<XenForoNode, int> _f$parentNodeId = Field(
    'parentNodeId',
    _$parentNodeId,
    opt: true,
  );
  static int? _$displayOrder(XenForoNode v) => v.displayOrder;
  static const Field<XenForoNode, int> _f$displayOrder = Field(
    'displayOrder',
    _$displayOrder,
    opt: true,
  );
  static bool? _$displayInList(XenForoNode v) => v.displayInList;
  static const Field<XenForoNode, bool> _f$displayInList = Field(
    'displayInList',
    _$displayInList,
    opt: true,
  );
...
mixin XenForoNodeMappable {
  String toJson() {
    return XenForoNodeMapper.ensureInitialized().encodeJson<XenForoNode>(
      this as XenForoNode,
    );
  }

  Map<String, dynamic> toMap() {
    return XenForoNodeMapper.ensureInitialized().encodeMap<XenForoNode>(
      this as XenForoNode,
    );
  }
  ...
  @override
  String toString() {
    return XenForoNodeMapper.ensureInitialized().stringifyValue(
      this as XenForoNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoNodeMapper.ensureInitialized().equalsValue(
      this as XenForoNode,
      other,
    );
  }
