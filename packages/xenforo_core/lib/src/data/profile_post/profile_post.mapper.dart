...
class XenForoProfilePostMapper extends ClassMapperBase<XenForoProfilePost> {
  ...
  static const Field<XenForoProfilePost, String> _f$username = Field(
    'username',
    _$username,
    opt: true,
  );
  static String? _$messageParsed(XenForoProfilePost v) => v.messageParsed;
  static const Field<XenForoProfilePost, String> _f$messageParsed = Field(
    'messageParsed',
    _$messageParsed,
    opt: true,
  );
  static bool? _$canEdit(XenForoProfilePost v) => v.canEdit;
  static const Field<XenForoProfilePost, bool> _f$canEdit = Field(
    'canEdit',
    _$canEdit,
    opt: true,
  );
  static bool? _$canSoftDelete(XenForoProfilePost v) => v.canSoftDelete;
  static const Field<XenForoProfilePost, bool> _f$canSoftDelete = Field(
    'canSoftDelete',
    _$canSoftDelete,
    opt: true,
  );
  static bool? _$canHardDelete(XenForoProfilePost v) => v.canHardDelete;
  static const Field<XenForoProfilePost, bool> _f$canHardDelete = Field(
    'canHardDelete',
    _$canHardDelete,
    opt: true,
  );
  static bool? _$canReact(XenForoProfilePost v) => v.canReact;
  static const Field<XenForoProfilePost, bool> _f$canReact = Field(
    'canReact',
    _$canReact,
    opt: true,
  );
  ...
  static const Field<XenForoProfilePost, bool> _f$canViewAttachments = Field(
    'canViewAttachments',
    _$canViewAttachments,
    opt: true,
  );
  static String? _$viewUrl(XenForoProfilePost v) => v.viewUrl;
  static const Field<XenForoProfilePost, String> _f$viewUrl = Field(
    'viewUrl',
    _$viewUrl,
    opt: true,
  );
  static XenForoUser? _$profileUser(XenForoProfilePost v) => v.profileUser;
  static const Field<XenForoProfilePost, XenForoUser> _f$profileUser = Field(
    'profileUser',
    _$profileUser,
    opt: true,
  );
  ...
  static const Field<XenForoProfilePost, bool> _f$isReactedTo = Field(
    'isReactedTo',
    _$isReactedTo,
    opt: true,
  );
  static int? _$visitorReactionId(XenForoProfilePost v) => v.visitorReactionId;
  static const Field<XenForoProfilePost, int> _f$visitorReactionId = Field(
    'visitorReactionId',
    _$visitorReactionId,
    opt: true,
  );
  static int _$profilePostId(XenForoProfilePost v) => v.profilePostId;
  static const Field<XenForoProfilePost, int> _f$profilePostId = Field(
    'profilePostId',
    _$profilePostId,
  );
  static int? _$profileUserId(XenForoProfilePost v) => v.profileUserId;
  static const Field<XenForoProfilePost, int> _f$profileUserId = Field(
    'profileUserId',
    _$profileUserId,
    opt: true,
  );
  static int? _$userId(XenForoProfilePost v) => v.userId;
  static const Field<XenForoProfilePost, int> _f$userId = Field(
    'userId',
    _$userId,
    opt: true,
  );
  static int? _$postDate(XenForoProfilePost v) => v.postDate;
  static const Field<XenForoProfilePost, int> _f$postDate = Field(
    'postDate',
    _$postDate,
    opt: true,
  );
  static String? _$message(XenForoProfilePost v) => v.message;
  static const Field<XenForoProfilePost, String> _f$message = Field(
    'message',
    _$message,
    opt: true,
  );
  static String? _$messageState(XenForoProfilePost v) => v.messageState;
  static const Field<XenForoProfilePost, String> _f$messageState = Field(
    'messageState',
    _$messageState,
    opt: true,
  );
  static String? _$warningMessage(XenForoProfilePost v) => v.warningMessage;
  static const Field<XenForoProfilePost, String> _f$warningMessage = Field(
    'warningMessage',
    _$warningMessage,
    opt: true,
  );
  static int? _$commentCount(XenForoProfilePost v) => v.commentCount;
  static const Field<XenForoProfilePost, int> _f$commentCount = Field(
    'commentCount',
    _$commentCount,
    opt: true,
  );
  static int? _$firstCommentDate(XenForoProfilePost v) => v.firstCommentDate;
  static const Field<XenForoProfilePost, int> _f$firstCommentDate = Field(
    'firstCommentDate',
    _$firstCommentDate,
    opt: true,
  );
  static int? _$lastCommentDate(XenForoProfilePost v) => v.lastCommentDate;
  static const Field<XenForoProfilePost, int> _f$lastCommentDate = Field(
    'lastCommentDate',
    _$lastCommentDate,
    opt: true,
  );
  static int? _$reactionScore(XenForoProfilePost v) => v.reactionScore;
  static const Field<XenForoProfilePost, int> _f$reactionScore = Field(
    'reactionScore',
    _$reactionScore,
    opt: true,
  );
  static XenForoUser? _$user(XenForoProfilePost v) => v.user;
  static const Field<XenForoProfilePost, XenForoUser> _f$user = Field(
    'user',
    _$user,
    opt: true,
  );
...
mixin XenForoProfilePostMappable {
  ...
  XenForoProfilePostCopyWith<
    XenForoProfilePost,
    XenForoProfilePost,
    XenForoProfilePost
  >
  get copyWith =>
      _XenForoProfilePostCopyWithImpl<XenForoProfilePost, XenForoProfilePost>(
        this as XenForoProfilePost,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return XenForoProfilePostMapper.ensureInitialized().stringifyValue(
      this as XenForoProfilePost,
    );
  }
  ...
  bool operator ==(Object other) {
    return XenForoProfilePostMapper.ensureInitialized().equalsValue(
      this as XenForoProfilePost,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoProfilePostMapper.ensureInitialized().hashValue(
      this as XenForoProfilePost,
    );
  }
}
...
abstract class XenForoProfilePostCopyWith<
  $R,
  $In extends XenForoProfilePost,
  $Out
>
...
class _XenForoProfilePostCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    >
  >?
  get latestComments => $value.latestComments != null
      ? ListCopyWith(
  ...
  XenForoProfilePost $make(CopyWithData data) => XenForoProfilePost(
    ...
    firstCommentDate: data.get(#firstCommentDate, or: $value.firstCommentDate),
