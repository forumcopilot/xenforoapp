...
class XenForoConversationMapper extends ClassMapperBase<XenForoConversation> {
  ...
  static const Field<XenForoConversation, String> _f$username =
...
mixin XenForoConversationMappable {
  ...
  XenForoConversationCopyWith<XenForoConversation, XenForoConversation,
      XenForoConversation> get copyWith => _XenForoConversationCopyWithImpl<
          XenForoConversation, XenForoConversation>(
      this as XenForoConversation, $identity, $identity);
  @override
  String toString() {
    return XenForoConversationMapper.ensureInitialized()
        .stringifyValue(this as XenForoConversation);
  }

  @override
  bool operator ==(Object other) {
    return XenForoConversationMapper.ensureInitialized()
        .equalsValue(this as XenForoConversation, other);
  }

  @override
  int get hashCode {
    return XenForoConversationMapper.ensureInitialized()
        .hashValue(this as XenForoConversation);
  }
}
...
abstract class XenForoConversationCopyWith<$R, $In extends XenForoConversation,
