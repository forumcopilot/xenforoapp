...
mixin XenForoThreadFieldMappable {
  ...
  XenForoThreadFieldCopyWith<XenForoThreadField, XenForoThreadField,
          XenForoThreadField>
      get copyWith => _XenForoThreadFieldCopyWithImpl<XenForoThreadField,
          XenForoThreadField>(this as XenForoThreadField, $identity, $identity);
  @override
  String toString() {
    return XenForoThreadFieldMapper.ensureInitialized()
        .stringifyValue(this as XenForoThreadField);
  }

  @override
  bool operator ==(Object other) {
    return XenForoThreadFieldMapper.ensureInitialized()
        .equalsValue(this as XenForoThreadField, other);
  }

  @override
  int get hashCode {
    return XenForoThreadFieldMapper.ensureInitialized()
        .hashValue(this as XenForoThreadField);
  }
}
...
abstract class XenForoThreadFieldCopyWith<$R, $In extends XenForoThreadField,
