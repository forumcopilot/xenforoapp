...
class XenForoThreadPrefixMapper extends ClassMapperBase<XenForoThreadPrefix> {
  ...
  static const Field<XenForoThreadPrefix, int> _f$prefixId = Field(
    'prefixId',
    _$prefixId,
  );
  static String? _$title(XenForoThreadPrefix v) => v.title;
  static const Field<XenForoThreadPrefix, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static String? _$description(XenForoThreadPrefix v) => v.description;
  static const Field<XenForoThreadPrefix, String> _f$description = Field(
    'description',
    _$description,
    opt: true,
  );
  static String? _$usageHelp(XenForoThreadPrefix v) => v.usageHelp;
  static const Field<XenForoThreadPrefix, String> _f$usageHelp = Field(
    'usageHelp',
    _$usageHelp,
    opt: true,
  );
  static bool? _$isUsable(XenForoThreadPrefix v) => v.isUsable;
  static const Field<XenForoThreadPrefix, bool> _f$isUsable = Field(
    'isUsable',
    _$isUsable,
    opt: true,
  );
  static int? _$prefixGroupId(XenForoThreadPrefix v) => v.prefixGroupId;
  static const Field<XenForoThreadPrefix, int> _f$prefixGroupId = Field(
    'prefixGroupId',
    _$prefixGroupId,
    opt: true,
  );
  static int? _$displayOrder(XenForoThreadPrefix v) => v.displayOrder;
  static const Field<XenForoThreadPrefix, int> _f$displayOrder = Field(
    'displayOrder',
    _$displayOrder,
    opt: true,
  );
  static int? _$materializedOrder(XenForoThreadPrefix v) => v.materializedOrder;
  static const Field<XenForoThreadPrefix, int> _f$materializedOrder = Field(
    'materializedOrder',
    _$materializedOrder,
    opt: true,
  );
...
mixin XenForoThreadPrefixMappable {
  ...
  XenForoThreadPrefixCopyWith<
    XenForoThreadPrefix,
    XenForoThreadPrefix,
    XenForoThreadPrefix
  >
  get copyWith =>
      _XenForoThreadPrefixCopyWithImpl<
        XenForoThreadPrefix,
        XenForoThreadPrefix
      >(this as XenForoThreadPrefix, $identity, $identity);
  @override
  String toString() {
    return XenForoThreadPrefixMapper.ensureInitialized().stringifyValue(
      this as XenForoThreadPrefix,
    );
  }

  @override
  bool operator ==(Object other) {
    return XenForoThreadPrefixMapper.ensureInitialized().equalsValue(
      this as XenForoThreadPrefix,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return XenForoThreadPrefixMapper.ensureInitialized().hashValue(
      this as XenForoThreadPrefix,
    );
  }
}
...
abstract class XenForoThreadPrefixCopyWith<
  $R,
  $In extends XenForoThreadPrefix,
  $Out
>
...
class _XenForoThreadPrefixCopyWithImpl<$R, $Out>
  ...
  XenForoThreadPrefix $make(CopyWithData data) => XenForoThreadPrefix(
    ...
    materializedOrder: data.get(
      #materializedOrder,
      or: $value.materializedOrder,
    ),
  );
