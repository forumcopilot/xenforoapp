...
class XenForoPollMapper extends ClassMapperBase<XenForoPoll> {
  ...
  static const Field<XenForoPoll, bool> _f$canVote =
      Field('canVote', _$canVote, opt: true);
  static bool? _$hasVoted(XenForoPoll v) => v.hasVoted;
  static const Field<XenForoPoll, bool> _f$hasVoted =
...
mixin XenForoPollMappable {
  String toJson() {
    return XenForoPollMapper.ensureInitialized()
        .encodeJson<XenForoPoll>(this as XenForoPoll);
  }

  Map<String, dynamic> toMap() {
    return XenForoPollMapper.ensureInitialized()
        .encodeMap<XenForoPoll>(this as XenForoPoll);
  }

  XenForoPollCopyWith<XenForoPoll, XenForoPoll, XenForoPoll> get copyWith =>
      _XenForoPollCopyWithImpl<XenForoPoll, XenForoPoll>(
          this as XenForoPoll, $identity, $identity);
  @override
  String toString() {
    return XenForoPollMapper.ensureInitialized()
        .stringifyValue(this as XenForoPoll);
  }

  @override
  bool operator ==(Object other) {
    return XenForoPollMapper.ensureInitialized()
        .equalsValue(this as XenForoPoll, other);
  }
